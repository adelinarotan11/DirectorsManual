...
namespace DirectorsManual.Web
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
			...
			from = "oksanarotan15@gmail.com";
			password = "rotan223";
			//message.Destination = "oksanarotan15@gmail.com";
			#endregion
			//адрес и порт smtp-server с которого будем отправлять письмо
			...
			//create a message:message.Destination-адрес получателя
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            manager.PasswordValidator = new PasswordValidator
            {
                ...
                RequireDigit = true,
                RequireLowercase = true,//нижний р.
                RequireUppercase = false,//верхний регистр
            };
